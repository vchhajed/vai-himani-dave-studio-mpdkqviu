...
const heroImages = [
  { src: 'https://source.unsplash.com/1600x900/?business%2Coffice%2Cprofessional&sig=0',             label: 'Evening Wear' },
  { src: 'https://source.unsplash.com/1600x900/?team%2Cmeeting%2Ccorporate&sig=1',                  label: 'Bridal Collections' },
  { src: 'https://source.unsplash.com/1600x900/?city%2Cbuilding%2Cmodern&sig=2',                     label: 'Sarees & Traditional' },
  { src: 'https://source.unsplash.com/1600x900/?workspace%2Cclean%2Cbright&sig=3',      label: 'Fusion Wear' },
];
      ...
      <div className="container hero-split">
        ...
        <div className="hero-content">
          <div className="hero-eyebrow">
            ...
            <span className="hero-sub-tag">Designer Fashion Studio</span>
          </div>
        ...
        <div className="hero-visual">
          ...
          <div className="hero-float-badge">
            <span className="hero-float-num">Bespoke</span>
            <span className="hero-float-text">Crafted Couture</span>
          </div>
        </div>
      </div>
