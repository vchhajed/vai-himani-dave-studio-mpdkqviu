...
const metrics = [
  { num: '8+', label: 'Years of Design Excellence' },
  { num: '500+', label: 'Custom Pieces Created' },
  { num: '100%', label: 'Handcrafted Quality' },
  { num: '4-6', label: 'Week Average Turnaround' },
];
      ...
      <div className="container about-grid section">
        ...
        <div className="about-img-col">
          <div className="about-img-wrap">
            <Image
              src={about.image || '/products/designer-collection.jpeg'}
              alt="Himani Dave Studio Designer Collection"
              fill
            ...
            <div className="about-corner-badge">
              <span className="about-badge-num">Bespoke</span>
              <span className="about-badge-label">Design Excellence</span>
            </div>
          </div>
        </div>
      </div>
